...
export default function CoursePlayer({ courseId, initialLessonId, onNavigate }: CoursePlayerProps) {
  ...
  return (
    <div className="w-full bg-[#FAFCFA] min-h-screen font-sans box-border overflow-x-hidden pb-10">
              ...
              <div className="mt-6 pt-4 border-t border-[#E5ECE7] space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 w-full">
                  ...
                  >
                    ...
                    <span className="break-words">{completedLessonIds.includes(activeLesson.id) ? 'Completed' : 'Mark Complete'}</span>
                  </button>
              ...
              <div className="space-y-4 overflow-y-auto max-h-[50vh] lg:max-h-[600px] pr-1">
                {sections.map((section) => (
                  <div key={section.id} className="space-y-2">
                    <strong className="text-xs font-bold text-[#17221B] block leading-tight mb-2 font-sans break-words pr-2">
                        ...
                        return (
                          ...
                          >
                            <div className="pr-2 min-w-0">
                              <p className={`break-words ${isActive ? 'text-[#17221B]' : 'text-[#17221B]'}`}>
                                {lesson.title}
                              </p>
